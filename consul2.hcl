...
bind_addr = "192.168.90.2" # Listen on all IPv4
#:w
# Advertise addr - if you want to point clients to a different address than bind or LB.
#advertise_addr = "192.168.90.2"
...
#encrypt = "SF4wJsz9QK+F4n7EnBYKJi1khZC/zka0E40sk9vvrJI="
...
retry_join = ["192.168.90.2","192.168.90.3","192.168.90.4","192.168.90.10"]
#retry_join = ["[::1]:8301"]
